...
import { User,  Mail, Loader2 , Phone, Building, BookOpen, GraduationCap } from 'lucide-vue-next'; // Adjust the path as necessary
    ...
    <form @submit.prevent="handleSubmit" class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="md:col-span-2 text-center mt-6">
        <button type="submit" :disabled="loading"
          class="bg-primary text-white py-2 px-10 cursor-pointer rounded-xl hover:bg-blue-700 transition flex justify-center items-center gap-2 mx-auto">
  ...
  <div
    ...
    <div class="flex justify-center mb-4">
      <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none"
        stroke="#092c67" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 text-sm text-gray-700 dark:text-gray-200 text-left px-8 mb-6">
  ...
  <p v-if="studentData?.faculty" class="flex items-center gap-2">
    ...
    <div class="flex justify-center gap-4 mt-6">
      <button @click="confirmStart" :disabled="!acceptedTerms" :class="{
