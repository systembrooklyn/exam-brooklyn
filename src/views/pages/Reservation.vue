<template>
      ...
      <form @submit.prevent="handleSubmit" class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="md:col-span-2">
          ...
          <div class="relative">
            ...
            <input v-model="form.fullName" type="text" class="form-input pl-10" placeholder="Please enter full English name" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <MapPin class="absolute top-1/2 left-3 transform -translate-y-1/2 w-5 h-5 text-blue-500" />
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input v-model="form.calledBy" type="text" class="form-input pl-10" placeholder="Enter caller name" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <ListOrdered class="absolute top-1/2 left-3 transform -translate-y-1/2 w-5 h-5 text-blue-500" />
            <input v-model="form.waitingNumber" type="number" class="form-input pl-10" placeholder="e.g., 23" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <UserCircle class="absolute top-1/2 left-3 transform -translate-y-1/2 w-5 h-5 text-blue-500" />
            <input v-model="form.calledBy" type="text" class="form-input pl-10" placeholder="Enter caller name" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input v-model="form.dob" type="date" class="form-input pl-10 appearance-none bg-white text-gray-800 dark:bg-gray-700 dark:text-white" />
          </div>
        </div>
        ...
        <div>
          ...
          <input v-model="form.nationalId" type="text" class="form-input" maxlength="14" placeholder="12345678901234" />
        </div>
        ...
        <div class="md:col-span-2">
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
            <label v-for="n in nationalities" :key="n" class="inline-flex items-center">
              <input type="checkbox" v-model="form.nationalities" :value="n" class="mr-2" />
              {{ n }}
            </label>
          </div>
        </div>
    ...
    <div>
        ...
        <div>
          ...
          <input v-model="form.faculty" type="text" class="form-input" placeholder="Faculty name" />
        </div>
  
        <!-- Major -->
        <div>
          <label class="form-label">Major</label>
          <input v-model="form.major" type="text" class="form-input" placeholder="Major" />
        </div>
  ...
  import { User, MapPin, Phone, Mail, Calendar, ListOrdered, UserCircle } from 'lucide-vue-next';
  ...
  const nationalities = [
    'Egyptian', 'Sudanese', 'KSA', 'UAE', 'Bahrain', 'Syrian',
    'Iraq', 'Palestinian', 'Yemeni', 'Algerienne', 'Ethiopian', 'Other',
  ];
