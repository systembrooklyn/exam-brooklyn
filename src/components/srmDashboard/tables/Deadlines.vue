<template>
  <div class="space-y-4 min-w-4xl">
    ...
    <div
      ...
      :key="rowIndex"
      class="bg-white p-3 rounded-lg shadow-md border border-gray-200 hover:scale-105 transition duration-200"
    >
...
watch(
  () => props.data,
  (newData) => {
    sortedData.value = sortByDate(newData, "due_date", sortOrderLocal.value);
  },
  { immediate: true }
);
