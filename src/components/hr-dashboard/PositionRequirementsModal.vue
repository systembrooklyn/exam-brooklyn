<template>
  <HrModal :show="show" :title="isUpdate ? 'Update Position Requirements' : 'Add Position Requirements'"
    :loading="saving" @close="closeModal" @save="handleSave">
    <div class="space-y-6">
        ...
        <div class="bg-gray-50 p-4 rounded-xl border border-gray-100 space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input v-model="form.education_level" type="text"
        ...
        <div class="bg-gray-50 p-4 rounded-xl border border-gray-100 space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input v-model="form.age_min" type="number" min="18"
                class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all"
                placeholder="18" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Max Age</label>
              <input v-model="form.age_max" type="number" min="18"
                class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all"
                placeholder="60" />
            </div>
          </div>
        ...
        <div class="bg-gray-50 p-4 rounded-xl border border-gray-100 space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="md:col-span-2">
              ...
              <MultiSelect v-model="form.shift_ids" :options="shiftOptions" labelKey="shift_name" subLabelKey="timing"
                valueKey="id" placeholder="Select Shifts" />
            </div>
            <div class="md:col-span-2">
              <label class="block text-sm font-medium text-gray-700 mb-1">Keywords</label>
              <div
                class="w-full border border-gray-300 rounded-lg p-2 focus-within:ring-2 focus-within:ring-indigo-500/20 focus-within:border-indigo-500 transition-all bg-white flex flex-wrap gap-2 min-h-[46px]">
                <span v-for="(kw, idx) in form.keywords" :key="idx"
                  class="bg-indigo-50 text-indigo-700 text-sm py-1 px-2.5 rounded-full inline-flex items-center gap-1 border border-indigo-100">
                  {{ kw }}
                ...
                <input v-model="keywordInput" @keydown="onKeywordKeydown"
                  type="text" class="flex-1 min-w-[120px] outline-none bg-transparent"
