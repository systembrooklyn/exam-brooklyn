<template>
  <div class="w-full overflow-x-auto bg-white rounded-lg shadow-md">
    ...
    <!-- Loading Spinner -->
    <div v-if="!filteredItems.length && loading" class="flex justify-center items-center py-20">
    ...
    <div v-else>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr v-for="item in paginatedItems" :key="item.id" class="hover:bg-gray-50 transition-colors">
            <td v-for="header in headers" :key="header.key" class="px-6 py-4 whitespace-nowrap break-words">
              ...
              <span v-if="header.key === 'name' || header.key === 'student.name'" @click="showDetails(item)"
            ...
            <td class="px-6 py-4 whitespace-nowrap space-x-6">
              ...
              <button v-show="!isReservation || canDelete" @click="$emit('delete', item.id)"
      ...
      <!-- Pagination -->
      <div class="flex justify-center gap-3 mt-4 p-4" v-if="filteredItems.length > 0">
